package com.adams.swfbuilder.containers
{
	...
	public class MXMLPanel extends Panel
	{
		...
		private function handleOk(e:WidthHeightEvent):void
		{
			...
			if(e.percentWidth != null) percentWidth = e.percentWidth;
			if(e.percentHeight != null) percentHeight = e.percentHeight;
